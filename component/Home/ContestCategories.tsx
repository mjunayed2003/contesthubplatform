...
import { ChevronsRight, Gift, Palette, BarChart2 } from "lucide-react";

const categories = [
  {
    title: "Giveaways",
    description:
      "Simple task-based contests. Follow, share, and enter for a chance to win random draws.",
  ...
  },
  {
    ...
    description:
      "Upload photos, designs, or text. Let the community vote on your work to win prizes.",
    count: "45 active contests",
  ...
  },
  {
    title: "Polls & Voting",
    description:
      "Cast your vote on trending topics. Instant results and participation rewards.",
    count: "45 active contests",
    ...
    <section className="w-full bg-[#FFFFFF] py-16 sm:py-20 px-4 sm:px-8">
      <div className="max-w-[1560px] mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {categories.map(({ title, description, count, browseLabel, href, Icon }) => (
            <div
              key={title}
            ...
            >
              ...
              <div className="flex items-center justify-between">
                ...
                <a
                  href={href}
                  className="flex items-center gap-1 text-[#A01C1C] text-[13px] sm:text-[14px] font-semibold hover:gap-2 transition-all duration-200"
                >
                  {browseLabel}
