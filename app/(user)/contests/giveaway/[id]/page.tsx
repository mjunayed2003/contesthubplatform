...
import {
  ...
  CheckCircle, Twitter, Mail, UploadCloud, Flag, X
} from "lucide-react";
        ...
        <div className="bg-white rounded-[24px] shadow-xl border border-gray-100 p-6 sm:p-10 min-h-[500px]">
                  ...
                  <>
                    ...
                    <div className="bg-[#FFF5F7] rounded-xl p-5 border border-red-100">
                      ...
                      <div className="mt-4 flex gap-3 flex-wrap">
                        <button
                          onClick={() => router.push(`/dashboard/giveaway/${params.id}`)}
                          className="px-6 py-3 border border-green-500 text-green-500 hover:bg-green-100 font-bold rounded-lg transition-colors"
                        >
                          View Entries
                        </button>
                        <button
                          onClick={handleParticipate}
                          className="px-6 py-3 bg-[#A01C1C] hover:bg-[#861717] text-white font-bold rounded-lg shadow-md transition-transform active:scale-95"
                        >
                          Participate Now
                        </button>
                      </div>
          ...
          {step === 3 && (
            <div className="max-w-md mx-auto py-10 flex flex-col items-center text-center animate-in zoom-in-95 duration-500">
              <div className="w-20 h-20 rounded-full flex items-center justify-center mb-6 shadow-sm" style={{ backgroundColor: '#fde8e8' }}><CheckCircle size={40} style={{ color: '#9b1c1c' }} /></div>
              <h2 className="text-3xl font-bold mb-2" style={{ color: '#9b1c1c' }}>Entry Confirmed!</h2>
          ...
          <div className="bg-white rounded-2xl w-full max-w-md p-6 shadow-2xl relative animate-in zoom-in-95 duration-200">
            ...
            {reportSuccess ? (
              <div className="py-8 flex flex-col items-center text-center">
                ...
                <p className="text-gray-500 text-sm">Thank you for letting us know. We will review this giveaway shortly.</p>
              </div>
            ) : (
              <>
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h3 className="text-xl font-bold text-gray-900">Report Giveaway</h3>
                </div>
                
                <p className="text-sm text-gray-500 mb-4">
                  Please describe why you are reporting this giveaway. Your report will be sent to the admin team for review.
                </p>
                ...
                <textarea
                  ...
                  placeholder="E.g., Fake prize, suspicious link, misleading information..."
